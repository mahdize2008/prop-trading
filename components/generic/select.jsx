...
export default function SelectBox({ label, options, formatOption , leftSideLabel }) {
    ...
    return (
        <div className="select-wrap">
            ...
            <Select
                ...
                options={options}
                getOptionLabel={(option) => (formatOption ? formatOption(option) : option.label)}
                formatOptionLabel={(option) => (formatOption ? formatOption(option) : option.label)}
